...
scenario "creation fails with correct username and pasword consisting of letters", {
    ...
    when 'a valid username and password consisting of letters are entered',{
        element = driver.findElement(By.name("username"));
        element.sendKeys("maria4");
        element = driver.findElement(By.name("password"));
        element.sendKeys("uuuuuuuu");
        element = driver.findElement(By.name("passwordConfirmation"));
        element.sendKeys("uuuuuuuu");
        element = driver.findElement(By.name("add"));
        element.submit();
...
scenario "creation fails with too short username and valid pasword", {
    ...
    when 'a too sort username and valid password are entered',{
        element = driver.findElement(By.name("username"));
        element.sendKeys("mari");
        element = driver.findElement(By.name("password"));
        element.sendKeys("uuuuuuu!");
        element = driver.findElement(By.name("passwordConfirmation"));
        element.sendKeys("uuuuuuu!");
        element = driver.findElement(By.name("add"));
        element.submit();
...
scenario "can not login with account that is not succesfully created", {
    ...
    when 'a invalid username/password are entered',{
        element = driver.findElement(By.name("username"));
        element.sendKeys("batora");
        element = driver.findElement(By.name("password"));
        element.sendKeys("jeejee");
        element = driver.findElement(By.name("login"));
        element.submit();
    }
